...
public class RNZoomsdkModule extends ReactContextBaseJavaModule implements ZoomSDKInitializeListener, MeetingServiceListener {
  ...
  public RNZoomsdkModule(ReactApplicationContext reactContext) {
    super(reactContext);
